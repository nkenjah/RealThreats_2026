...
export default function ProspectsEdit({ prospect }: Props) {
    const { data, setData, patch, processing, errors } = useForm({
        ...
        gpa: prospect.gpa ?? '',
        entry_term: prospect.entry_term ?? '',
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        patch(`/admin/admissions/prospects/${prospect.id}`);
    };

    return (
        <>
            <Head
                title={`Edit: ${prospect.first_name} ${prospect.last_name}`}
            />
            ...
            <div className="space-y-6 p-6">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold">
                        Edit Prospect: {prospect.first_name}{' '}
                        {prospect.last_name}
                    </h1>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex gap-2">
                            <Button type="submit" disabled={processing}>
                                {processing ? 'Updating...' : 'Update Prospect'}
                            </Button>
