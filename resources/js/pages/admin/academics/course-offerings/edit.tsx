...
export default function OfferingsEdit({
    courseOffering,
    courses,
    programs,
}: Props) {
    const { data, setData, patch, processing, errors } = useForm({
        course_id: String(courseOffering.course_id),
        program_id: String(courseOffering.program_id),
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        patch(`/admin/offerings/${courseOffering.id}`);
    };
                ...
                <div className="max-w-lg rounded-lg border bg-card p-6">
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Updating...' : 'Update Offering'}
                        </Button>
                    </form>
                </div>
            </div>
