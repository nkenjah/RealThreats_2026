...
export default function CoursePrerequisitesCreate({ courses }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/admin/curriculum/course-prerequisites');
    };

    return (
        <>
            <Head title="Create Course Prerequisite" />
                ...
                <div className="max-w-lg rounded-lg border bg-card p-6">
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Creating...' : 'Create Prerequisite'}
                        </Button>
                    </form>
                </div>
            </div>
...
CoursePrerequisitesCreate.layout = {
    breadcrumbs: [
