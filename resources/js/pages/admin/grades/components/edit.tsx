...
export default function ComponentsEdit({
    ...
    const { data, setData, patch, processing, errors } = useForm({
        course_offering_id: String(gradebookComponent.course_offering_id),
        name: gradebookComponent.name,
        type: gradebookComponent.type,
        max_score: String(gradebookComponent.max_score),
        weight: String(gradebookComponent.weight),
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        patch(`/admin/gradebook-components/${gradebookComponent.id}`);
    };
                ...
                <div className="max-w-lg rounded-lg border bg-card p-6">
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Updating...' : 'Update Component'}
                        </Button>
                    </form>
                </div>
            </div>
