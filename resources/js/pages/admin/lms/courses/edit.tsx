...
export default function LMSCoursesEdit({ course, courseOfferings }: Props) {
    const { data, setData, patch, processing, errors } = useForm({
        course_offering_id: String(course.course_offering_id),
        name: course.name,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        patch(`/admin/lms/courses/${course.id}`);
    };

    return (
        <>
            <Head title="Edit LMS Course" />
            ...
            <div className="space-y-6 p-6">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold">Edit LMS Course</h1>
                </div>
